//
//  FileUploadButtonExtraTools.swift
//  SparkDemo
//
...
struct FileUploadButtonExtraTools: ComponentExtraTools {
    ...
    let swiftUICodeSyntaxes: [CodeSyntax] = FileUploadButtonCodeSyntaxes.content
