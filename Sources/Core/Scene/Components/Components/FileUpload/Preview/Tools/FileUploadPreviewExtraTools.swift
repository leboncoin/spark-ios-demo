//
//  FileUploadPreviewExtraTools.swift
//  SparkDemo
//
...
struct FileUploadPreviewExtraTools: ComponentExtraTools {
    ...
    let swiftUICodeSyntaxes: [CodeSyntax] = FileUploadPreviewCodeSyntaxes.content
